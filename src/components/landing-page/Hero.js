          ...
          <nav className="nav">
            ...
            <div className="nav-links">
              {[
                ...
                { label: "Eye Exam", href: "/eye-exam" },
                { label: "About", href: "/about" },
                { label: "Contact", href: "/contact" },
              ].map((item,i) => (
                <a key={item.label} href={item.href} className={`nav-link ${i===0?"active":""}`}>{item.label}</a>
              ))}
            </div>
            ...
            <div className="bento-grid">
              ...
              <div className="bento-card bento-large">
                ...
                <div className="bento-overlay">
                  ...
                  <a href="/collections/aviator" className="bento-card-link">VIEW SERIES</a>
                </div>
              </div>
              {/* Modern Minimalist */}
              <div className="bento-card bento-small">
                ...
                <div className="bento-overlay-always">
                  ...
                  <a href="/collections/minimalist" className={`bento-card-link bento-card-link-white`}>DISCOVER</a>
                </div>
              </div>
              {/* Femme Elegance */}
              <div className="bento-card bento-small2">
                ...
                <div className="bento-overlay-always">
                  ...
                  <a href="/collections/femme" className={`bento-card-link bento-card-link-white`}>EXPLORE</a>
                </div>
              </div>
              {/* Desc Card */}
